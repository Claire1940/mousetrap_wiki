...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Mouse Trap Wiki",
    description: "Read the Terms of Service for Mouse Trap Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our board game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Mouse Trap Wiki",
      description: "Terms and conditions for using Mouse Trap Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Mouse Trap Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Mouse Trap Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Mouse Trap Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Mouse Trap Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the board game "Mouse Trap". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Rules and chain-reaction trap mechanics</li>
              <li>Cheese collection and trap-building strategies</li>
              <li>Multiplayer and turn-by-turn walkthroughs</li>
              <li>Mouse outfit and character guides</li>
              <li>Platform and game availability updates</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Mouse Trap Wiki is NOT affiliated with, endorsed by, or associated with
              Marmalade Game Studio or Hasbro. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Mouse Trap Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Marmalade Game Studio and/or Hasbro. We use such
            ...
            <ul>
              ...
              <li><strong>Platform Availability:</strong> The game's availability across platforms (mobile, console, Steam) and game updates may change without notice. We are not responsible for platform access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, MOUSE TRAP WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Mouse Trap Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@mousetrap.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@mousetrap.wiki</a>
            </p>
            <p>
