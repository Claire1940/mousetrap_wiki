...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Mouse Trap Wiki',
    description: 'Copyright and intellectual property information for Mouse Trap Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Mouse Trap Wiki',
      description: 'Copyright and intellectual property information for Mouse Trap Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Mouse Trap Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Mouse Trap Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Mouse Trap Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Hasbro</strong> - Owner of the Mouse Trap board game trademark and IP</li>
              <li><strong>Marmalade Game Studio</strong> - Developer of the digital Mouse Trap adaptation</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>Mouse Trap</strong> - Trademark of Hasbro, the board game IP owner</li>
              <li><strong>Marmalade Game Studio</strong> - Developer of the digital adaptation</li>
              <li><strong>Mouse Trap Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Mouse Trap Wiki.
            </p>
            ...
            <p>
              ...
              Mouse Trap Wiki<br />
              Email: <a href="mailto:dmca@mousetrap.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@mousetrap.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Mouse Trap Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Mouse Trap Wiki (mousetrap.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@mousetrap.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@mousetrap.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@mousetrap.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@mousetrap.wiki</a>
            </p>
            <p>
